...
def main(admin_name, admin_id, student_id):
    ...
    title_label = Label(root, text="ADMIN STUDENT FEE PROFILE CONTROL", fg="#1e293b", bg="white", font=("Segoe UI", 20, "bold"))
    ...
    lbl_fee_title = Label(root, text="ACADEMIC FEE LEDGER CONTROL", font=("Segoe UI", 16, "bold"), fg="#0d9488", bg="white")
    ...
    # Transaction Section
    Label(root, text="ADJUST SEMESTER FEE (AMOUNT IN ₹)", font=("Segoe UI", 12, "bold"), fg="#3b82f6", bg="white").place(x=750, y=370)
    ...
    btn_add.place(x=750, y=465, width=150, height=45)
    ...
    btn_deduct.place(x=920, y=465, width=150, height=45)
