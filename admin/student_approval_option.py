...
def main(admin_name, admin_id):
    ...
    Label(root, text="Student Management", fg="#78350f", bg=bg_color, font=("Segoe UI", 26, "bold")).place(x=400, y=100)

    btn_pending = Button(root, text="Student Pending List", fg="white", bg="#8b5cf6", activebackground="#7c3aed", activeforeground="white", font=("Segoe UI", 20, "bold"), bd=0, cursor="hand2", command=pending)
    ...
    btn_approved = Button(root, text="Approved Students List", fg="white", bg="#0d9488", activebackground="#0f766e", activeforeground="white", font=("Segoe UI", 20, "bold"), bd=0, cursor="hand2", command=list_approved)
