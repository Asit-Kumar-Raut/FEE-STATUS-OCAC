...
def main(admin_name, admin_id):
    ...
    # Search Bar
    Label(root, text="Search Fully Paid Student ID:", font=("Segoe UI", 11, "bold"), fg="#1e293b", bg="white").place(x=100, y=155)
    ...
    def display_students(student_list):
        ...
        if not student_list:
            lbl_empty = Label(table_frame, text="No fully paid students found yet!⌛", fg="#ef4444", bg="white", font=("Segoe UI", 14, "bold"))
            ...
            for s in student_list:
                ...
                l5.place(x=700, y=y)
                l6 = Label(table_frame, text=f"₹ {pending:,}", font=("Segoe UI", 10, "bold"), fg="#10b981", bg="white")
                l6.place(x=850, y=y)
                ...
                btn_view = Button(table_frame, text="Adjust Fee", fg="white", bg="#3b82f6", font=("Segoe UI", 9, "bold"), bd=0, cursor="hand2", command=make_view_cmd(s_id))
