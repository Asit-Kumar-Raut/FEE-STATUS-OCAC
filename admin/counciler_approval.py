...
def main(admin_name, admin_id):
    ...
    btn_approved = Button(root, text="Counselor Approval List", fg="white", bg="red", activebackground="#b91c1c", activeforeground="white", font=("Helvetica", 30), cursor="hand2", command=list)
