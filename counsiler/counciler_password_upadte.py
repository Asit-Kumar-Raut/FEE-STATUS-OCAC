...
def main(counselor_name="Counselor User", counselor_id="1"):
    root = Tk()
    ...
    def update():
        ...
        # Check if the username, counselor_id, and current password match
        sql = "SELECT * FROM  counselors  WHERE username=%s AND counselor_id=%s AND password=%s"
        values = (u, uid, cp)
