...
def main():
    ...
    btn_login = Button(root, text="LOGIN AS STUDENT", fg="white", bg=accent_teal, activebackground="#0f766e", activeforeground="white", font=("Segoe UI", 12, "bold"), bd=0, cursor="hand2", command=login_action)
    btn_login.place(x=1000, y=410, width=300, height=40)
    btn_login.bind("<Enter>", lambda e: btn_login.config(bg="#0f766e"))
    btn_login.bind("<Leave>", lambda e: btn_login.config(bg=accent_teal))
